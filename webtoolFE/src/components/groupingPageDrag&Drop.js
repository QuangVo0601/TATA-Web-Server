/* This is code from design team */

// to be used with groupingPage.js to enable drag and drop functionality
function DragAndDrop() {
    ...
    //get the collection of draggable targets (groups) and add their draggable attribute
    ...
    //get the collection of draggable items (samples) and add their draggable attributes
