...
One <- Zero[,grepl("G1", colnames(Zero))] 
...
MyData <- cbind(One, Two, Three, Four, Five, Six, Seven, Eight, Nine, Ten)

Group1 <- grep("G1",names(Zero), value= T)
...
condition <- rbind(Group1, Group2, Group3, Group4, Group5, Group6, Group7, Group8, Group9, Group10)
